    ...
    <footer id="contact" className="w-full py-12 md:py-16 bg-background-secondary rounded-t-lg">
      <ScrollReveal>
        <div className="flex justify-center items-center gap-6 mb-12">
          ...
          <a
            href="https://instagram.com/skatfx.group"
            target="_blank"
            rel="noopener noreferrer"
            className="text-prose-secondary hover:text-prose-primary transition-colors"
          ...
          <a
            href="https://www.tiktok.com/skattfx"
            target="_blank"
            rel="noopener noreferrer"
            className="text-prose-secondary hover:text-prose-primary transition-colors"
            aria-label="TikTok"
          ...
          <a
            href="https://wa.me/message/FBBXP4SJC3XTC1"
            target="_blank"
            rel="noopener noreferrer"
            className="text-prose-secondary hover:text-prose-primary transition-colors"
            aria-label="WhatsApp"
